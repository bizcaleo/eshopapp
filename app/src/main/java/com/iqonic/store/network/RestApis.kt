...
import com.iqonic.store.utils.extensions.getApiToken
import com.iqonic.store.utils.extensions.getUserId
...
interface RestApis {
    ...
    @GET("iqonic-api/api/v1/woocommerce/get-product")
    fun Search(@QueryMap options:Map<String, String>): Call<StoreProductModelNew>
